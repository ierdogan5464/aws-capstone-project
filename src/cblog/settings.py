...
def get_ssm_parameters():
    ...
    username_param = ssm.get_parameter(Name="/ishak/capstone/username", WithDecryption=True)
    password_param = ssm.get_parameter(Name="/ishak/capstone/password", WithDecryption=True)
...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-db.c34se6qcsawx.us-east-1.rds.amazonaws.com',
        'PORT': '3306',
    }
}
...
AWS_STORAGE_BUCKET_NAME = 'ishak-capstone-django' # please enter your s3 bucket name
